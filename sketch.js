...
function preload() {
  ...
  laughSound=loadSound("sounds/assets_pirate_laugh.mp3");
  bgSound=loadSound("sounds/assets_background_music.mp3");
  explosionSound = loadSound("sounds/assets_cannon_explosion.mp3");
  waterSound = loadSound("sounds/assets_cannon_water.mp3");
